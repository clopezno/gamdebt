...
```
```{r}
ggsave("comment_density.png",plot=comment_density,path ="./OUTPUT/FIGURES/h1p4/",dpi = 600,scale = 1 )
```
...
```
```{r}
ggsave("code_to_test.png",plot=code_to_test,path ="./OUTPUT/FIGURES/h1p4/",dpi = 600,scale = 1.5 )
```
...
```
```{r}
ggsave("tests.png",plot=tests,path ="./OUTPUT/FIGURES/h1p4/",dpi = 600,scale = 1 )
```
...
```
```{r}
ggsave("branch_coverage.png",plot=branch_coverage,path ="./OUTPUT/FIGURES/h1p4/",dpi = 600,scale = 1.5 )
```
...
```
```{r}
ggsave("smells_density.png",plot=smells_density,path ="./OUTPUT/FIGURES/h1p4/",dpi = 600,scale = 1.5 )
```
...
```
```{r}
ggsave("sqale_debt_ratio.png",plot=sqale_debt_ratio,path ="./OUTPUT/FIGURES/h1p4/",dpi = 600,scale = 1.5 )
```

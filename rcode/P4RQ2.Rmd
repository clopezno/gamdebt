...
```{r}
comment_density<-
ggplot(data = p4s, aes(x = group_gamification, y = comment_density, label = ID)) +
...
```{r}
p4s_br <- betareg(formula = comment_density ~ group_gamification, data = p4s)
```
...
```{r}
ggpredict(p4s_br, terms = "group_gamification")
```
...
pairs(emmeans(p4s_br, "group_gamification"))
```
...
```{r}
code_to_test <-
ggplot(data = p4s, aes(x = group_gamification, y = code_to_test, label = ID)) +
  geom_boxplot(outlier.size = -1, colour = "gray60") +
...
```
```{r}
ggsave("code_to_test.png",plot=code_to_test,path ="./OUTPUT/FIGURES/h2p4/",dpi = 600,scale = 1 )
```
...
```{r}
p4s_br <- betareg(formula = code_to_test ~ group_gamification, data = p4s)
```
...
```{r}
tests <-
ggplot(data = p4s, aes(x = group_gamification, y = test_success_density, label = ID)) +
  geom_boxplot(outlier.size = -1, colour = "gray60") +
...
ggplot(data = p4s, aes(x = group_gamification, y = test_success_density.rescaled, label = ID)) +
  geom_boxplot(outlier.size = -1, colour = "gray60") +
...
```{r}
p4s_br <- betareg(formula = test_success_density.rescaled ~ group_gamification, data = p4s)
```
...
```{r}
branch_coverage <-
ggplot(data = p4s, aes(x = group_gamification, y = branch_coverage, label = ID)) +
  geom_boxplot(outlier.size = -1, colour = "gray60") +
...
```
```{r}
ggsave("branch_coverage.png",plot=branch_coverage,path ="./OUTPUT/FIGURES/h2p4/",dpi = 600,scale = 1 )
```
...
```{r}
ggplot(data = p4s, aes(x = group_gamification, y = branch_coverage.rescaled, label = ID)) +
  geom_boxplot(outlier.size = -1, colour = "gray60") +
...
```{r}
p4s_br <- betareg(formula = branch_coverage.rescaled ~ group_gamification, data = p4s)
```
...
```{r}
smells_density <-
ggplot(data = p4s, aes(x = group_gamification, y = smells_density, label = ID)) +
  geom_boxplot(outlier.size = -1, colour = "gray60") +
...
```{r}
ggsave("smells_density.png",plot=smells_density,path ="./OUTPUT/FIGURES/h2p4/",dpi = 600,scale = 1 )
```
...
```{r}
p4s_br <- betareg(formula = smells_density ~ group_gamification, data = p4s)
```
...
```{r}
sqale_debt_ratio <-
ggplot(data = p4s, aes(x = group_gamification, y = sqale_debt_ratio, label = ID)) +
  geom_boxplot(outlier.size = -1, colour = "gray60") +
...
```{r}
ggsave("sqale_debt_ratio.png",plot=sqale_debt_ratio,path ="./OUTPUT/FIGURES/h2p4/",dpi = 600,scale = 1 )
```
...
```{r}
ggplot(data = p4s, aes(x = group_gamification, y = sqale_debt_ratio.rescaled, label = ID)) +
  geom_boxplot(outlier.size = -1, colour = "gray60") +
...
```{r}
p4s_br <- betareg(formula = sqale_debt_ratio.rescaled ~ group_gamification, data = p4s)
```
